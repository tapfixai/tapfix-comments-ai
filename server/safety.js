...
const cyrillicSexualPattern = /(анальн[а-я]*|анус|задниц[а-я]*|жоп[а-я]*|секс|порно|интим|гол[а-я]*|минет|оральн[а-я]*|сос[а-я]*|сиськ[а-я]*|груд[ьяи]|возбуд[а-я]*|трах[а-я]*|член|хуй|пизд[а-я]*|еб[а-я]*)/i;
...
const sexualContextPattern = /\b(lit|bed)\b.{0,48}\b(défaire|defaire|undress|unmake)\b|\b(défaire|defaire|undress|unmake)\b.{0,48}\b(lit|bed)\b|\b(show|send|more|want|need)\b.{0,24}\b(feet|foot)\b|\b(feet|foot)\b.{0,24}\b(pics?|video|please|pls)\b|прозрачн[а-я]*.{0,36}(одежд[а-я]*|стринг[а-я]*|вер[её]вочк[а-я]*)|(одежд[а-я]*|стринг[а-я]*|вер[её]вочк[а-я]*).{0,36}прозрачн[а-я]*|без\s+(стринг[а-я]*|вер[её]вочк[а-я]*)/i;
